...
Current state: **v0.1.0 public UI foundation release**. This repo ships a package shell, health/root endpoints, documentation gates, canonical zoning schema models, Alembic migration scaffold, sample parcel/zone lookup API, sample use/dimensional rule APIs, citation-grounded sample Q&A, planner-escalation/staff-context samples, and an accessible public sample UI at `/civiczone`. It does **not** yet use live LLM calls, ingest live GIS data, make zoning determinations, or replace planner review.
