...
| Runtime install proof | Historical pass | Fresh WSL editable install succeeded after switching to the published CivicCore release wheel and enabling direct references in Hatch metadata. Current release alignment is CivicCore v1.2.0. |
