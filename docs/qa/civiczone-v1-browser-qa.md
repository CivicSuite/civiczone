...
Checked states: loading, success, empty, error, partial. Checked copy: legal/determination boundary, actionable empty-state fix path, staff-only precedent boundary. Checked keyboard: skip link and API docs link receive focus. Browser console had no errors.
