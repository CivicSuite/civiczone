...
Current state: `0.1.1` public UI foundation release. The package, health endpoints, canonical zoning schema, Alembic migrations, sample parcel/zone lookup API, sample use/dimensional rule APIs, citation-grounded sample Q&A, staff-context samples, an accessible public sample UI at `/civiczone`, and `civiccore==0.3.0` dependency alignment exist. Live LLM calls, live GIS import, authentication/RBAC, and production workflow screens are not implemented yet.
