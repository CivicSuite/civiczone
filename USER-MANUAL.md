...
CivicZone is a FastAPI Python package pinned to the published CivicCore v1.2.0 release wheel. The current runtime exposes:
...
CivicZone --> CivicCore["CivicCore v1.2.0"]
